  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        Education & Training: A good dentist should have proper qualifications, including a degree from an accredited dental school, and should be licensed to practice in your region. They may also have specializations, such as orthodontics, periodontics, or endodontics.
        Continuous Education: Dentistry is an ever-evolving field. A dedicated dentist stays updated on the latest techniques, materials, and technologies to provide the best care..
        </p>
