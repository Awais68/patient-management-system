				...
				<div>
					{request.status === "rejected" ? (
						<Button
							size='icon'
							variant='outline'
							className='bg-red-500 hover:bg-red-100 text-red-600'>
						...
						<Button
							size='icon'
							variant='outline'
							className='bg-green-500 hover:bg-green-100 text-blue-600'>
						...
						<div className='space-x-2'>
							<Button
								size='icon'
								variant='outline'
								className='bg-green-500 hover:bg-green-100 text-green-600'
								onClick={onAccept}>
								<CheckIcon className='h-4 w-4' />
								<span className=' sr-only'>Accepted Doctor Request</span>
							</Button>
